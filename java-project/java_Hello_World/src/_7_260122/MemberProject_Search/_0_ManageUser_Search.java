...
public class _0_ManageUser_Search {
...
//        List<_0_MemberBase_HashMap> members = new ArrayList<>();
        Map<String, _0_MemberBase_Search> members = new HashMap<>();
        /*
        ...
        //프로그램 시작시 회원 정보 불러오기
        _0_MemberBase_Search loginMember = null;  //실습2 수정1: 로그인한 유저가 있는지 확인할 변수를 처음에 없으므르 null로 설정
        //콘솔에 입력 내용 불러오는 도구.
            ...
            switch (choice) {
                case 1:	//회원가입
                    ...
                    try {
                        ...
                        _0_NormalMember_Search newMember = new _0_NormalMember_Search(name, email, password, age);    //실습 수정8: 생성자의 매개변수에 password 추가
...
//                                .sorted(Map.Entry.comparingByKey(Comparator.reverseOrder()))  //키 기준 내림차순
                                .sorted(Map.Entry.comparingByValue(Comparator.comparing(_0_MemberBase_Search::getAge)  //주 기준 나이순 오름차순
                                        .thenComparing(_0_MemberBase_Search::getName, Comparator.reverseOrder()))) //부 기준 이름순 내림차순
...
//                        }
                ...
                case 3:
                    if(loginMember == null) {
                        ...
                        if(members.containsKey(inputEmail)) {
                            _0_MemberBase_Search member = members.get(inputEmail);
                ...
                case 5:
                    ...
                    if(searchType.equals("1")) {
                        ...
                        for(_0_MemberBase_Search member : members.values()) {
    ...
    //준비물:
    //1)메모리에 저장된 배열
    public static void saveMembers(Map<String, _0_MemberBase_Search> members) {
    ...
    public static void loadMembers(Map<String, _0_MemberBase_Search> members) {
        ...
        try {
            ...
            while((line = br.readLine()) != null) {
                ...
                if(data.length == 4) {
                    ...
                    members.put(email, new _0_NormalMember_Search(name, email, password, age));
                }
            }
